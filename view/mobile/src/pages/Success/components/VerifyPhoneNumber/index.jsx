...
const VerifyPhoneNumber = ({ field }) => {
    return (
        <div className="w-full text-center space-y-5">
            ...
            <p 
                aria-label = "please check inbox for the one-time password"
                className  = "pt-2 lg:text-2xl md:text-lg sm:text-md sm:tracking-[1px] sm:leading-7 text-robo-primaryTwo" 
                tabIndex   = {0}
            > 
                Please check your inbox for the <br/> verification link. {<VerificationNote field={field} />}
            </p>
        </div>
    )
}

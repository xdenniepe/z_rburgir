...
const Modal = ({ isModalOpen, setIsModalOpen }) => {
    const { dispatch, setLocationViewMode, setSelectedVendingMachine } = useLocationCtx()
    ...
    const handleLocationSwitch = () => {
        ...
        setLocationViewMode(dispatch, 'map')
                    ...
                    >
                        <div className="flex flex-col justify-center items-center">
                            ...
                            <div className="flex flex-col gap-[22px] xs:gap-[18px] xxs:gap-4 w-full">
                                ...
                                <Button 
                                    classes = "text-robo-currency bg-robo-primaryOne tracking-wide text-sm xs:text-xs sm:text-sm xxs:text-xs"
